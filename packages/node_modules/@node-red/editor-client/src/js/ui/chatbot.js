RED.chatbot = (function() {
    ...
    function createApiKeyInput() {
        ...
        var title = $('<h3>AnthropicAPI Key Required</h3>').appendTo(card);
        title.css({
            'margin-bottom': '15px',
            'font-size': '15px',
            'color': '#fff'
        ...
        var description = $('<p>Please enter your Anthropic API key to use the Nerco AI Assistant.</p>').appendTo(card);
        description.css({
            'margin-bottom': '25px',
            'color': '#aaa',
            'text-align': 'center'
        ...
        var apiKeyInput = $('<input type="password" class="red-ui-chatbot-api-key-input" placeholder="Enter your Anthropic API key...">').appendTo(inputGroup);
        apiKeyInput.css({
            'flex': '1',
            'padding': '10px',
    ...
    function createChatbotContent() {
        ...
        // Add welcome message
        addSystemMessage("Hi 👋 I can help you create flows or answer questions about Node-RED. Ask me anything or describe a flow you'd like to build.");
