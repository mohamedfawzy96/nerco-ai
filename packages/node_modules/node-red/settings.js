 ...
 * - Used by the Node-RED Assistant to generate flows using OpenAI
 ******************************************************************************/
    
    /** OpenAI API configuration for Node-RED Assistant
     * These settings are used by the ChatBot assistant to generate flows
    ...
    openai: {
        ...
        /** The model to use for flow generation
         * For best results, use GPT-4 or newer models that have better
         * coding capabilities.
         * Options include: "gpt-4", "gpt-4-turbo", "gpt-3.5-turbo"
         */
        model: "gpt-4",
